...
/**
 * This class is a region/cuboid from one location to another. It can be used for blocks protection
 * and things like WorldEdit.
 *
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    /**
     * Expand the Cuboid in the given direction by the given amount. Negative amounts will shrink the
     * Cuboid in the given direction. Shrinking a cuboid's face past the opposite face is not an error
     * and will return a valid Cuboid.
     *
    ...
    public Cuboid outset(CuboidDirection dir, int amount) {
        return switch (dir) {
            case Horizontal -> expand(CuboidDirection.North, amount)
    ...
    /**
     * Inset (shrink) the Cuboid in the given direction by the given amount. Equivalent to calling
     * outset() with a negative amount.
     *
    ...
    /**
     * Get the average light level of all empty (air) blocks in the Cuboid. Returns 0 if there are no
     * empty blocks.
     *
    ...
    /**
     * Contract the Cuboid, returning a Cuboid with any air around the edges removed, just large
     * enough to include all non-air blocks.
     *
    ...
    /**
     * Contract the Cuboid in the given direction, returning a new Cuboid which has no exterior empty
     * space. E.g. A direction of Down will push the top face downwards as much as possible.
     *
    ...
    /**
     * Get the Cuboid representing the face of this Cuboid. The resulting Cuboid will be one block
     * thick in the axis perpendicular to the requested face.
     *
    ...
    /**
     * Get a block relative to the lower NE point of the Cuboid in the given World. This version of
     * getRelativeBlock() should be used if being called many times, to avoid excessive calls to
     * getWorld().
     *
     * @param w - The world
     * @param x - The X co-ordinate
    ...
    public String toString() {
        return String.format("Cuboid: %s,%d,%d,%d=>%d,%d,%d", this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2, this.z2);
    }
