...
public enum Flag {
    INVINCIBLE(
            "Active l'invincibilité pour les joueurs",
            new ItemStack(Material.IRON_SWORD),
            LandType.SYSTEM),
    PVP("Active le pvp", new ItemStack(Material.DIAMOND_SWORD), LandType.SYSTEM),
    AUTO_REPLANT(
            "Active l'auto replantation", new ItemStack(Material.GOLDEN_SHOVEL), LandType.SYSTEM),
    DOORS_AUTOCLOSE(
            "Active la fermeture automatique des portes",
            new ItemStack(Material.OAK_DOOR),
            LandType.SYSTEM),
    NO_MOB_SPAWNING(
            "Désactive le spawn des mobs", new ItemStack(Material.ZOMBIE_SPAWN_EGG), LandType.SYSTEM),
    INVISIBLE(
            "Rend les joueurs à l'intérieur invisibles.",
            new ItemStack(Material.POTION),
            LandType.SYSTEM),
    INSTANT_TELEPORT(
            "Supprime le délais des téléportation depuis ce territoire.",
            new ItemStack(Material.ENDER_PEARL),
            LandType.SYSTEM),
    EXPLOSIONS("Active les explosions", new ItemStack(Material.TNT)),
    BLOCK_DAMAGES_BY_ENTITY(
            "Active les dégâts aux blocs par les entités (endermans, withers...)",
            new ItemStack(Material.DIRT)),
    PRESSURE_PLATE_BY_ENTITY(
            "Active l'utilisation des plaques de pression par les entités",
            new ItemStack(Material.OAK_PRESSURE_PLATE)),
    TRIPWIRE_BY_ENTITY(
            "Active l'utilisation des crochets par les entités", new ItemStack(Material.TRIPWIRE_HOOK)),
    ...
    LIQUID_SPREAD(
            "Autorise les liquides extérieurs au claim à se propager.",
            new ItemStack(Material.LAVA_BUCKET)),
    SHOP_MONEY_TO_GUILD_BANK(
            "Rediriger l'argent des shops à la banque de la guilde.",
