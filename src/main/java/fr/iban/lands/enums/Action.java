...
public enum Action {
    ...
    OPEN_CONTAINER(
            "Ouvrir les conteneurs (coffre, fours, hoopers...)",
    ...
    USE(
            "Utiliser les portes, trappes, répéteurs...",
    ...
    SET_WARP(
            "Mettre un warp dans votre claim", new ItemStack(Material.NETHER_STAR), ActionGroup.PLUGINS),
    SET_HOME(
            "Mettre une résidence (home) dans votre claim",
    ...
    USE_RESPAWN_ANCHOR(
            "Utiliser les ancres de réapparition",
            new ItemStack(Material.RESPAWN_ANCHOR),
            ActionGroup.USE),
    USE_ANVIL("Utiliser les enclumes", new ItemStack(Material.ANVIL), ActionGroup.USE),
    ENTITY_INTERACT(
            "Interagir avec les entités (ex: villageois)",
            new ItemStack(Material.EMERALD),
            ActionGroup.INTERACT),
    LECTERN_TAKE(
            "Prendre/poser des livres sur les pupitres",
            new ItemStack(Material.LECTERN),
            ActionGroup.USE),
    LECTERN_READ(
            "Lire les livres dans les pupitres", new ItemStack(Material.LECTERN), ActionGroup.USE),
    BREWING_STAND_INTERACT(
            "Utiliser les alambics", new ItemStack(Material.BREWING_STAND), ActionGroup.USE),
    PHYSICAL_INTERACT(
            "Interactions physiques (plaques de pression, crochets...)",
            new ItemStack(Material.OAK_PRESSURE_PLATE),
            ActionGroup.INTERACT),
    FLOWER_POT_INTERACT(
            "Interactions avec les pots de fleurs",
            new ItemStack(Material.FLOWER_POT),
            ActionGroup.INTERACT),
    OTHER_INTERACTS(
            "Autres interactions (oeuf de dragon, poudre d'os...)",
    ...
    ARMOR_STAND_INTERACT(
            "Interagir avec un porte armure.", new ItemStack(Material.ARMOR_STAND), ActionGroup.INTERACT),
    FROST_WALK(
            "Générer de la glace avec l'enchantement semelles givrantes",
            new ItemStack(Material.PACKED_ICE),
            ActionGroup.BUILDING),
    CHORUS_TELEPORT(
            "Se téléporter en mangeant des chorus",
            new ItemStack(Material.CHORUS_FRUIT),
            ActionGroup.TELEPORT),
    ENDER_PEARL_TELEPORT(
            "Se téléporter avec des ender pearls",
            new ItemStack(Material.ENDER_PEARL),
            ActionGroup.TELEPORT),
    CAULDRON_FILL_EMPTY(
            "Remplir/vider un chaudron", new ItemStack(Material.CAULDRON), ActionGroup.BUILDING),
    VEHICLE_PLACE_BREAK(
            "Poser/casser des véhicules (bateaux, minecarts)",
            new ItemStack(Material.MINECART),
            ActionGroup.BUILDING),
    CHANGE_BEACON_EFFECT(
            "Changer l'effet des balises", new ItemStack(Material.BEACON), ActionGroup.USE),
